    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Pridať Kupón
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Pridať Kupón
           ...
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Produkt </label> 
                      
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          
                          <select name="product_id" class="form-control" required>
                          
                            <option selected disabled>Vyber produkt pre Kupón</option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Kód Kuponu </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="Vytvoriť kupón" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    if($check_coupons==1){
        ...
        echo "<script>alert('Kód kupónu / produkt už bol pridaný. Vyberte iný kód / produkt kupónu')</script>";
        ...
        if($run_coupon){
            ...
            echo "<script>alert('Kupón bol pridaný.')</script>";
