    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Upraviť Podmienky
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Upraviť Podmienky
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="update" value="Upraviť" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['update'])){
    ...
    if($run_term){
        ...
        echo "<script>alert('Tvoja Podmienka bola upravená.')</script>";
