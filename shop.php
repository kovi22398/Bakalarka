    ...
    ?> 
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
                ...
                <div class='box'><!-- box Begin -->
                    <h1>Obchod</h1>
                    <p>
                        Nachádzate sa v nákupnej zóne nášho krásneho zahradníctva. <br> <br> 
                        Najdete tu množtvo oblúbených položiek ktoré si môžete nechať doružiť až k Vám domov alebo si pre tovar prísť osobne k nám do záhradnictva.
                        Osobne v záhradnictve najdete širší výber rastín a príslušenstva.
                    </p>
                </div><!-- box Finish -->
   ...
   <?php 
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            // Hide & Show Sidebar Toggle ROLETKA //
            ...
            $('.nav-toggle').click(function(){
                ...
                $('.panel-collapse,.collapse-data').slideToggle(700,function(){
                    ...
                    if($(this).css('display')=='none'){
                        ...
                        $(".hide-show").html('Ukázať');

                    }else{

                        $(".hide-show").html('Skryť');
