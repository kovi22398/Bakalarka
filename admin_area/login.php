...
<head>
    ...
    <title>Zahradnictvo Rosina</title>
...
<body>
   ...
   <div class="container"><!-- container begin -->
       <form action="" class="form-login" method="post"><!-- form-login begin -->
           <h2 class="form-login-heading"> Administrátor Login </h2>
           
           <input type="text" class="form-control" placeholder="E-mailová Adressa" name="admin_email" required>
           
           <input type="password" class="form-control" placeholder="Heslo" name="admin_pass" required>
...
<?php 
    ...
    if(isset($_POST['admin_login'])){
        ...
        if($count==1){
            ...
            echo "<script>alert('Úspešne Prihlásený. Vitaj späť.')</script>";
