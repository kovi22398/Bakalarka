...
<div class="row"><!-- row no: 2 begin -->
    ...
    <div class="col-lg-4 col-md-12"><!-- col-lg-3 col-md-6 begin -->
            ...
            <div class="panel-body"><!-- panel-body begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td>
                                    ...
                                    <?php 
                                       ...
                                       echo $order_status = 'Objednané';

                                    }elseif($order_status=='Pripravené'){

                                       echo $order_status = 'Pripravené';

                                    }else{

                                       echo $order_status = 'Neznáme';
                ...
                <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="index.php?view_orders"><!-- a href begin -->
                        ...
                        Zobraziť Všetky Objednávky: <i class="fa fa-arrow-circle-right"></i>
