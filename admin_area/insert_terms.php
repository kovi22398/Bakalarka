    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Pridať Podmienku
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Pridať Podmienku
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="Vytvoriť" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    if($run_term){
        ...
        echo "<script>alert('Podmienka bola Pridaná.')</script>";
        echo "<script>window.open('index.php?view_terms','_self')</script>";

    }else{
        
        echo "<script>alert('Podmienka nebola pridaná. Nastala niaka chyba.')</script>";
        echo "<script>window.open('index.php?insert_terms','_self')</script>";
