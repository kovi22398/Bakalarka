    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Upraviť Administrátora
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Upraviť Administrátora
           ...
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Krajina </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Pozícia </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Fotka </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> O mne </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="update" value="Upraviť profil" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['update'])){
    ...
    if($run_user){
        ...
        echo "<script>alert('Administrátor bol Aktualizovany.')</script>";
        echo "<script>window.open('login.php','_self')</script>";
